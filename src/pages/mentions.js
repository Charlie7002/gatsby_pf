    ...
    <Layout>
      ...
      <StyleMentions>
        ...
        <p>
          ...
          <a href="https://charlotte-cachet.com">
            https://charlotte-cachet.com
          </a>
        ...
        <p>
          <strong>Propriétaire</strong> : Auto entreprise -884 887 605-
          Charlotte Cachet – 56 bis rue du hurepoix 91470 Limours
          <br />
          <strong>Responsable publication</strong> : Cachet –
          contact@charlotte-cachet.com
          <br />
          Le responsable publication est une personne physique ou une personne
          morale.
          <br />
          <strong>Webmaster</strong> : Charlotte Cachet –
          contact@charlotte-cachet.com
          <br />
          <strong>Hébergeur</strong> : O2switch – 222 Boulevard Gustave Flaubert
          63000 Clermont-Ferrand 04 44 44 60 40
          <br />
          <strong>Délégué à la protection des données</strong> : Cachet
          Charlotte – contact@charlotte-cachet.com
          <br />
        </p>
        <h2>
        ...
        <p>
          ...
          le responsable du traitement des Données Personnelles est : Charlotte
          Cachet.
          <a href="https://charlotte-cachet.com">
            https://charlotte-cachet.com
          </a>
          est représenté par Cachet Charlotte, son représentant légal
        </p>
        <p>
        ...
        <p>
          Cachet Charlotte <br />
          56 bis rue du hurepoix 91470 Limours.
        </p>
        <p>
        ...
        <div ng-bind-html="rgpdHTML">
          ...
          <p>
            ...
            une période maximale de 9 mois mois après la fin de la relation
            contractuelle:
            <br />
            nom, prénom, email
          </p>
        ...
        <p>
          ...
          et Linkedin figurant sur le Site de
          <a href="https://charlotte-cachet.com">
            https://charlotte-cachet.com
          </a>
